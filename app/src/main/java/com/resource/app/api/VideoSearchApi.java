...
public class VideoSearchApi extends BaseApi<VideoSearchResultModel> {

    public VideoSearchApi(HttpListener listener, LifecycleProvider lifecycleProvider) {
        super(listener, lifecycleProvider);
    }

    @Override
    public UrlFactory setUrl() {
        return ApiConfig.VIDEO_SEARCH_INFO;
    }
