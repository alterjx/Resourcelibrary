...
public class UserExitApi extends BaseApi<UserInfo> {

    public UserExitApi(HttpListener listener, LifecycleProvider lifecycleProvider) {
        super(listener, lifecycleProvider);
    }

    @Override
    public UrlFactory setUrl() {
        return ApiConfig.USER_EXIT_API;
    }
